...
def fetch_openai_api_questions_and_answers(tag="openai-api", pagesize=100):
    """
    Fetch all questions tagged with 'openai-api' from StackOverflow using the Stack Exchange API.
...
# Fetch all questions tagged with "openai-api"
openai_api_data = fetch_openai_api_questions_and_answers(tag="openai-api", pagesize=100)
print(f"Fetched {len(openai_api_data)} questions with answers.")

# Extract the fields of interest
df = pd.DataFrame(openai_api_data)

# Save the DataFrame to a CSV file
output_filename = "stackoverflow_openai_api_questions_with_answers.csv"
