...
keywords = [
    "QNX", "BlackBerry QNX", "RTOS QNX", "QNX OS", "QNX Neutrino", "QNX Microkernel",
    "QNX POSIX", "QNX Reliability", "QNX Security", "QNX Scalability", "QNX Embedded",
    "Real-time OS QNX", "QNX Device Drivers", "QNX Memory Management", "QNX Multi-core Support",
    "QNX Real-time Performance", "QNX Industrial Control", "QNX Industrial Safety",
    "Automotive QNX", "QNX in Autonomous Vehicles", "QNX Automotive OS", "QNX Infotainment Systems",
    "QNX Advanced Driver Assistance Systems (ADAS)", "QNX Automotive Safety", "QNX in EVs",
    "QNX IVI (In-Vehicle Infotainment)", "QNX Security Features", "QNX Data Protection", 
    "QNX Encryption", "QNX Cybersecurity", "QNX Network Security", "QNX Fault Tolerance",
    "QNX High Availability", "QNX Safety Certification", "QNX ISO 26262 Compliance",
    "QNX Licensing", "QNX Certification", "QNX Revenue", "QNX Market Adoption", "QNX Partnerships",
    "QNX Business Strategy", "QNX Revenue Models", "QNX Market Share", "QNX SDK", 
    "QNX Development Tools", "QNX Momentics IDE", "QNX SDP", "QNX Application Development",
    "QNX Real-time Scheduling", "QNX Programming", "QNX API Reference", "QNX Integration with Linux",
    "QNX AI Integration", "QNX ML Support", "QNX Middleware", "QNX Cloud Integration",
    "QNX Edge Computing", "QNX Virtualization", "QNX Microservices", "QNX Use Cases",
    "QNX Future Trends", "QNX Architecture", "QNX Forums", "QNX Reddit Discussions", 
    "QNX Community Feedback", "QNX User Experiences", "QNX Technical Discussions", "QNX Debugging"
]
...
exclusion_subreddits = {"BB_Stock", "wallstreetbets"}
exclusion_domains = ["youtube.com", "vimeo.com"]
exclusion_keywords = ["/BB_Stock/", "/wallstreetbets/"]
